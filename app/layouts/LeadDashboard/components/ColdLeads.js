...
export default class ColdLeads extends Component {
  static navigationOptions = props => ({
    title: props.navigation.getParam(
      'Cold ',
      `Cold (${props.screenProps.count && props.screenProps.count.length > 0 ?
        props.screenProps.count[0].cold_leads : 0})`
    ),
  ...
  onDropDownChange = () => {
    ...
    storage.getItem('currentUser')
      .then(value => {
        ...
        dealer = dealerId;
        return this.props.getLeads('cold');
      }).then(() => {
