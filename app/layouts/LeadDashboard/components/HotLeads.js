...
export default class HotLeads extends Component {
  static navigationOptions = props => ({
    title: props.navigation.getParam(
      'Hot ',
      `Hot (${props.screenProps.count && props.screenProps.count.length > 0 ?
        props.screenProps.count[0].hot_leads : 0})`
    ),
  ...
  onDropDownChange = () => {
    ...
    storage.getItem('currentUser')
      .then(value => {
        ...
        dealer = dealerId;
        return this.props.getLeads('hot');
      }).then(() => {
